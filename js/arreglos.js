...
const buscarResultado = (categoria) => {
    let resultado = listaProductos.find(producto => producto.categoria === categoria)
...
let listaProductos2 = listaProductos.filter( producto => producto.categoria === 'Protector solar' )
